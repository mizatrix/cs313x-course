      ...
      <div className="page-container">
        ...
        <Link href="/review" className="review-zone-card animate-in">
          ...
          <div className="review-zone-content">
            ...
            <p>
              100 practice questions across all midterm topics — MCQs with instant grading and
        ...
        {/* Final Exam Training Zone CTA */}
        <Link href="/final-review" className="review-zone-card animate-in" style={{ marginTop: '1rem' }}>
          <div className="review-zone-icon">🏆</div>
          <div className="review-zone-content">
            <h3>
              Final Exam Training Zone
              <span className="review-zone-badge">NEW</span>
            </h3>
            <p>
              Cumulative practice for the final — every topic from Weeks 1–12, with extra focus on
              link analysis, web crawling, neural IR &amp; RAG, recommenders, and conversational AI.
              MCQs and worked problems, randomized on every visit.
            </p>
          </div>
          <div className="review-zone-arrow">Start Practice →</div>
        </Link>
