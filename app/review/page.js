...
import { reviewQuestions, reviewTopics } from '../data/reviewQuestions';
    ...
    <>
      ...
      <div className="page-container">
        <header className="page-header">
          ...
          <h1>🎯 Midterm Review Zone</h1>
          <p>
            Comprehensive practice covering all course topics. Test your understanding with
            multiple-choice and problem-solving questions — with instant feedback and explanations.
          </p>
          <div className="hero-stats">
            ...
            <div className="hero-stat">
              <div className="stat-num">{reviewTopics.length - 1}</div>
